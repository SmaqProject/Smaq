...
import ProfileQuestionCardBottom from './ProfileQuestionCardBottom';
...
function ProfileQuestionCard({ title, text, numberPeopleFollowingQuestion, answers, placeholder, isLoaded }) {
    if (placeholder){
      return(
        <Root>
